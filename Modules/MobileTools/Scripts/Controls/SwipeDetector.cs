...
namespace Pixeltron.MobileTools
{
    ...
    public class SwipeDetector : MobileControls
    {
        ...
        [Tooltip("Should swipe only count on release?")]
        ...
        void Update()
        {
            ...
            if (MobileGameManager.IsDesktop)
            {
                ...
                //TODO this code doesn't respect require release.
                //It just acts as if it is true.
            ...
            else
            {
                foreach (Touch touch in Input.touches)
                {
                    ...
                    if (touch.phase == TouchPhase.Moved && !requireRelease)
                    {
                        endtouch = touch.position;
